...
ListBox1.Canvas.FillRect(Rect);
    ...
    ListBox1.Canvas.Font.Size:= 16;
      ...
      if ListBox1.Items[Index] = '' then
        ...
        ListBox1.Canvas.TextOut(Rect.Left+round(2 * dpi_bilv), Rect.Top, '空');
        end else begin
                     if pos('!',ListBox1.Items[Index])> 0 then
                      begin
                        ListBox1.Canvas.Font.Color:= clred;
                        ListBox1.Canvas.TextOut(Rect.Left+round(2 * dpi_bilv), Rect.Top, '密');
                      end else begin
                                 ListBox1.Canvas.Font.Color:= clblue;
                                 ListBox1.Canvas.TextOut(Rect.Left+round(2 * dpi_bilv), Rect.Top, '存');
                               end;
                       end;
